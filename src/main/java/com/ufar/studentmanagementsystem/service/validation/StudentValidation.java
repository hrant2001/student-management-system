...
public class StudentValidation {
    public static boolean isValid(Student student) {
        return student != null
                && student.getCreatorId() != null && !(student.getCreatorId() <= 0)
                && student.getUniversityId() != null && !(student.getUniversityId() <= 0)
                ...
                && student.getFaculty() != null && student.getFaculty().isEmpty();
    }
}
